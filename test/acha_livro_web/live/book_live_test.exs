defmodule AchaLivroWeb.BookLiveTest do
  use AchaLivroWeb.ConnCase

  import Phoenix.LiveViewTest
  import AchaLivro.BooksFixtures

  @create_attrs %{description: "some description", title: "some title", image_url: "some image_url", price: "120.5"}
